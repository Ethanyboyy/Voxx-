...
CREATE TABLE "new_KnowledgeNode" (
    ...
    "researchItemId" TEXT,
    "objectiveId" TEXT,
    "labExperimentId" TEXT,
    "labSimulationId" TEXT,
    ...
    CONSTRAINT "KnowledgeNode_labExperimentId_fkey" FOREIGN KEY ("labExperimentId") REFERENCES "LabExperiment" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "KnowledgeNode_labSimulationId_fkey" FOREIGN KEY ("labSimulationId") REFERENCES "LabSimulation" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_KnowledgeNode" ("createdAt", "decisionId", "description", "experimentId", "goalId", "id", "ideaId", "label", "memoryId", "objectiveId", "projectId", "researchItemId", "taskId", "type", "updatedAt", "userId") SELECT "createdAt", "decisionId", "description", "experimentId", "goalId", "id", "ideaId", "label", "memoryId", "objectiveId", "projectId", "researchItemId", "taskId", "type", "updatedAt", "userId" FROM "KnowledgeNode";
...
CREATE UNIQUE INDEX "KnowledgeNode_labExperimentId_key" ON "KnowledgeNode"("labExperimentId");
CREATE UNIQUE INDEX "KnowledgeNode_labSimulationId_key" ON "KnowledgeNode"("labSimulationId");
