...
const fieldClasses =
  "w-full rounded-lg border border-border bg-[var(--surface-solid)] px-3 py-2 text-base text-foreground placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:border-[var(--border-strong)] transition-[border-color,box-shadow] duration-200 ease-[var(--ease-luxury)] sm:text-sm";
